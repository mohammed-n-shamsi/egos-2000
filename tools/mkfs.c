...
char* kernel_processes[] = {
    "../build/release/grass.elf",     "../build/release/sys_proc.elf",
    "../build/release/sys_file.elf",  "../build/release/sys_dir.elf",
...
char* contents[] = {
    ...
    "driver, tty driver, memory paging, address translation, interrupt "
    "handling, process scheduling and messaging, system call, file system, "
    "shell, 7 user commands and the `mkfs/mkrom` tools.",
    "./   6 ../   0 echo   7 cat   8 ls   9 cd  10 pwd  11 clock  12 crash1  "
    "13 crash2  14 ult  15 ",
